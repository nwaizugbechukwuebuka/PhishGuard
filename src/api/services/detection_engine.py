...
from ..models.quarantine import QuarantineReason, ThreatLevel
...
class DetectionEngine:
    ...
    async def analyze_email(
        ...
        try:
            ...
            return {
                ...
                "threat_indicators": [
                    "Analysis failed - defaulting to safe quarantine"
                ],
    ...
    async def _analyze_single_url(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"url": url, "is_suspicious": False, "indicators": []}
            ...
            for attachment in attachments:
                ...
                for ext in dangerous_extensions:
                    if filename.endswith(ext):
                        ...
                        attachment_analysis["indicators"].append(
                ...
                if any(filename.endswith(ext) for ext in dangerous_extensions):
                    if any(
                        ...
                        for doc_word in ["document", "invoice", "receipt", "report"]
                    ):
                        attachment_analysis["is_suspicious"] = True
                        attachment_analysis["indicators"].append(
    ...
    async def _check_sender_reputation(
        self, sender_email: str, headers: Dict[str, str]
    ) -> Dict[str, Any]:
    ...
    async def _check_subject_patterns(self, subject: str) -> Dict[str, Any]:
        ...
        try:
            ...
            keyword_count = sum(
                1 for keyword in suspicious_keywords if keyword in subject_lower
            )
            if keyword_count > 1:
            ...
            return {"is_suspicious": False, "indicators": [], "confidence_impact": 0.0}
    ...
    async def _check_content_patterns(self, content: str) -> Dict[str, Any]:
        ...
        try:
            ...
            grammar_errors = sum(
                1 for error in grammar_indicators if error in content_lower
            )
            if grammar_errors > 2:
    ...
    async def _check_urgency_indicators(
        ...
        try:
            ...
            return {"is_urgent": False, "indicators": [], "confidence_impact": 0.0}
    ...
    async def _check_social_engineering(self, content: str) -> Dict[str, Any]:
        ...
        try:
            ...
            reward_count = sum(
                1 for keyword in reward_keywords if keyword in content_lower
            )
            if reward_count > 0:
    ...
    async def _check_email_authentication(
        ...
        try:
            ...
            return {"auth_failed": False, "indicators": [], "confidence_impact": 0.0}
    ...
    async def _combine_analysis_results(
        ...
        try:
            ...
            return {
                ...
                "quarantine_reason": (
                    quarantine_reason.value if quarantine_reason else None
                ),
    ...
    async def update_threat_intelligence(
        self, new_indicators: Dict[str, List[str]]
    ) -> bool:
