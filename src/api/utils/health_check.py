        ...
        try:
            ...
            async with self.engine.begin() as conn:
                ...
                if row and row[0] == 1:
                    ...
                    pool_info = self.engine.pool.status() if hasattr(self.engine.pool, 'status') else {}
        ...
        try:
            ...
            try:
                ...
                integration_status["gmail"] = {
                    ...
                    "status": "configured" if gmail.credentials_path else "not_configured"
                }
            except Exception as e:
            ...
            try:
                ...
                integration_status["microsoft365"] = {"status": "error", "error": str(e)}
                overall_status = HealthStatus.DEGRADED
            ...
            try:
                ...
                integration_status["slack"] = {
                    ...
                    "status": "configured" if slack.is_configured() else "not_configured"
                }
            except Exception as e:
    ...
    async def run_checks(self) -> Dict[str, Any]:
        ...
        response = {
            ...
            "summary": {
                ...
                "healthy": sum(1 for r in check_results if r.status == HealthStatus.HEALTHY),
                "degraded": sum(1 for r in check_results if r.status == HealthStatus.DEGRADED),
                "unhealthy": sum(1 for r in check_results if r.status == HealthStatus.UNHEALTHY)
            }
        }
...
__all__ = [
    'HealthChecker', 'HealthStatus', 'HealthCheckResult', 'BaseHealthCheck',
    'DatabaseHealthCheck', 'RedisHealthCheck', 'ExternalServiceHealthCheck',
    'SystemResourcesHealthCheck', 'AIModelHealthCheck', 'IntegrationHealthCheck',
    'health_checker', 'initialize_health_checks', 'health_endpoint',
    'health_detailed_endpoint', 'health_component_endpoint'
]