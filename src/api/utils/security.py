...
# JWT configuration
JWT_SECRET_KEY = os.getenv("JWT_SECRET_KEY", "phishguard-secret-key-change-in-production")
    ...
    ROLES = {
        ...
        "security_analyst": {
            "permissions": [
                ...
                "users:read", "simulations:read", "simulations:write"
            ],
            "description": "Security analyst"
        },
        "user": {
            "permissions": [
                "emails:read", "reports:read",
                "simulations:participate", "profile:read", "profile:write"
            ],
            "description": "Regular user"
        },
        "viewer": {
            "permissions": [
                "reports:read", "emails:read"
            ],
...
__all__ = [
    'TokenManager', 'PasswordValidator', 'DataEncryption', 'AccessControl',
    'SecurityAudit', 'SecurityError', 'hash_password', 'verify_password',
    'generate_secure_token', 'hash_data', 'constant_time_compare',
    'password_validator', 'data_encryption', 'security_audit'
]
