...
class RedisRateLimiter:
    ...
    def get_key(self, request: Request, rule: RateLimitRule, identifier: str = None) -> str:
        """
    ...
    async def _in_memory_rate_limit(self, key: str, rule: RateLimitRule) -> Dict[str, Any]:
        """
    ...
    async def reset_limit(self, request: Request, rule: RateLimitRule, identifier: str = None):
        """
...
def create_rate_limit_middleware(rule_name: str = "default", identifier_func: Callable = None):
    """
...
__all__ = [
    'RedisRateLimiter', 'RateLimitRule', 'RateLimiterError',
