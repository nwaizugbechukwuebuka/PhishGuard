...
class RequestLoggerMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        try:
            ...
            # Log failed request
            await self._log_request_error(request_info, str(e), process_time, request_id)
        ...
        try:
            ...
            audit_log = AuditLog(
                ...
                metadata={
                    ...
                    "performance": {
                        "process_time_seconds": response_info.get("process_time_seconds")
                    }
                }
            )
    ...
    def _sanitize_sensitive_data(self, data: Any) -> Any:
        ...
        sensitive_fields = [
            ...
            "refresh_token", "credit_card", "ssn", "social"
        ]
...
class SecurityMonitor:
    ...
    def analyze_request(self, request_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(body, dict):
            text_to_analyze.extend(str(v).lower() for v in body.values() if isinstance(v, (str, int, float)))
                ...
                for pattern in patterns:
                    if pattern in text:
                        threats_detected.append({
                            "type": category,
                            "pattern": pattern,
                            "location": "url" if text == url_text else "parameters/body"
                        })
                        risk_score += 10
        ...
        for endpoint, stats in self.performance_data.items():
            if stats["request_count"] > 0:
                summary[endpoint] = {
                    ...
                    "slow_request_rate": stats["slow_request_count"] / stats["request_count"]
                }
