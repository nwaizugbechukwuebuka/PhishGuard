...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        self.user_tier_limits = {
            ...
            "admin": {"daily": float('inf'), "hourly": float('inf'), "minute": float('inf')}
        }
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        skip_paths = ["/health", "/metrics", "/docs", "/redoc", "/openapi.json", "/static"]
        ...
        try:
            ...
            if not rate_limit_result["allowed"]:
                ...
                raise HTTPException(
                    ...
                    headers={
                        ...
                        "X-RateLimit-Remaining": str(max(0, rate_limit_result["limit"] - rate_limit_result["current_usage"])),
            ...
            response.headers.update({
                "X-RateLimit-Limit": str(rate_limit_result["limit"]),
                "X-RateLimit-Remaining": str(max(0, rate_limit_result["limit"] - rate_limit_result["current_usage"] - 1)),
    ...
    async def _check_endpoint_limit(self, endpoint: str, client_id: str) -> Dict[str, Any]:
        """
    ...
    async def _check_user_tier_limits(self, user_id: str, user_tier: str) -> Dict[str, Any]:
        """
        ...
        Returns:
            Rate limit check result
        """
        tier_limits = self.user_tier_limits.get(user_tier, self.user_tier_limits["free"])
    ...
    async def _check_ddos_protection(self, client_id: str, request: Request) -> Dict[str, Any]:
        """
        ...
        suspicious_patterns = [
            ...
            request.headers.get("User-Agent", "").lower() in ["", "curl", "wget", "python-requests"]  # Bot-like agents
        ]
...
class RedisRateLimiter:
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379"):
        ...
        self.rules = {
            ...
            "auth": RateLimitRule(requests=10, window=60),      # 10 auth attempts per minute
...
def create_rate_limit_middleware(rule_name: str = "default", identifier_func: Optional[Callable] = None):
    """
    ...
    async def rate_limit_middleware(request: Request, call_next):
        ...
        try:
            ...
            response.headers["X-RateLimit-Reset"] = str(int(result.get("reset_time", time.time())))
...
__all__ = [
    'RateLimitMiddleware', 'RedisRateLimiter', 'RateLimitRule',
    'create_rate_limit_middleware', 'rate_limit', 'rate_limiter',
    'get_user_identifier', 'get_endpoint_identifier'
]