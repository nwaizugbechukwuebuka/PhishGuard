...
class GmailIntegration:
        ...
        try:
            ...
            for message_meta in messages:
                try:
                    ...
                    logger.error(f"Error processing Gmail message {message_meta.get('id')}: {e}")
                    continue
    ...
    async def quarantine_message(self, message_id: str) -> bool:
        ...
        try:
            ...
            quarantine_label_id = await self.get_or_create_label('PhishGuard-Quarantine')
    ...
    async def get_email_statistics(self) -> Dict[str, int]:
        ...
        try:
            ...
            quarantine_messages = await self.get_messages(
                query=f'label:{quarantine_label_id}', 
                max_results=1
            )
